...
export default function MerryChristMas1() {
        ...
        if (state === 'TREE') {
            ...
            photoMeshes.forEach((mesh, i) => {
                ...
                if (z > 5) {
                    ...
                    mesh.scale.lerp(new window.THREE.Vector3(distScale, distScale, distScale), 0.1);
                } else {
    ...
    return (
        <div>
            ...
            <div id="ui-layer">
                <div id="status" className="badge">🎄 Giang Sinh An Lanh 🎄</div>
                <div className="guide">
